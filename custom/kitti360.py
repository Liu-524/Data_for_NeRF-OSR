...
class KittiDataset(BaseDataset):
    def __init__(self, root_dir, split, downsample=1.0, **kwargs):
        ...
        test_id_normalized = test_id - frame_start
...
def test_vis():
    import vedo
    arrow_0 = vedo.Arrow((0, 0, 0), (0.66543162, 0.72569286, 0.17484458))
    arrow_1 = vedo.Arrow((0, 0, 0), (0.66543162, 0.72569286, 0.0), c='b', alpha=0.5)
    vedo.show([arrow_0, arrow_1], axes=1)
